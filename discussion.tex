...
The main conditions taken into account are accounted for by the REI marker system. 
...
E refers to the integrity of the element and the time indicates how long after ignition the fire penetrates the element and is visible on the non-heated side.
The last is the insulation ability, a limit is set to the temperature of the non-heated side.
...
Additionally the program could've been run for a longer time to ensure more samples. and thereby a closer approximation to the population mean. 
...
In retrospect there should have been more pretreatment? of the measured data before analysis was done. Inaccuracies arose due to the first 90 sec of the measurements being taken before the furnace was turned on and the thermocouples still measuring after the fire died down.
