...
\item{The air on the cold side remains at 20$^{^\circ}$C.}
	...
	An element of air was added at both ends. 
	In these elements, both heat convection and heat radiation need to be taken into account.
	\begin{figure}
	\centering
	...
	\begin{equation}
	q_{,x} - f = \frac{\partial Q}{\partial t} = c_p ? \frac{\partial u}{\partial t} ; q = -\kappa \frac{\partial u}{\partial x}
\end{equation}


\begin{equation}
\therefore -\kappa \frac{\partial^2 u}{\partial x^2} - f = c_p \frac{\partial u}{\partial t} \rightarrow f=0: \frac{\partial^2 u}{\partial x^2} = - \frac{c_p}{\kappa} \frac{\partial u}{\partial t} \quad \text{ or } \frac{\partial u}{\partial t} = -\alpha \frac{\partial^2 u}{\partial x^2}
\end{equation}
...
\begin{equation}
(2) \text{ Time integration -- waddefok gaan hier aan?} \\
