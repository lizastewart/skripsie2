...
A finite element model was constructed to model a 100mm element exposed to the ISO 846 Fire curve.
This model was used within the likelihood function of 
%Brief statement of what was found (Results);
New $\kappa$-values were found from MCMC and MAP analysis.
The MCMC and MAP $|kappa$-values were not equal which supports the hypothesis that the distribution is  not normal.
