...
\end{table}
 ...
 \iffalse
%TODO
From the difference between the histogram maximum and the maximum found by the Nelder-Mead optimization it is clear that many more iterations of the MCMC algorithm is needed.
An estimated of 100 000 iterations would be needed.
