...
\subsection{Heat conduction and diffusion}\label{heatconsec}	 
	Heat is transferred within an element if is a temperature gradient present. 
...
Calculating and comprehending (RIJK: Liewer modelling as die ander twee woorde) the behaviour of large and complex systems is a near impossible task without breaking the problem into smaller understandable parts.
